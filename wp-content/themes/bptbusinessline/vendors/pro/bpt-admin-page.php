		...
		<div class="wrap about-wrap">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td><h4><?php echo esc_html__('Header styles', 'bptbusinessline'); ?></h4></td>
						<td>1</span></td>
						<td>3</span></td>
					</tr>
					<tr>
						<td><h4><?php echo esc_html__('Banner styles', 'bptbusinessline'); ?></h4></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td>2</td>
					</tr>
                    <tr>
                    ...
                    <tr>
						<td><h4><?php echo esc_html__('Single Posts Share ', 'bptbusinessline'); ?></h4></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
                    <tr>
						<td><h4><?php echo esc_html__('Related Blog Posts', 'bptbusinessline'); ?></h4></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
                     <tr>
                     ...
                     <tr>
						<td><h4><?php echo esc_html__('Blog Layout Style', 'bptbusinessline'); ?></h4></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
                     <tr>
						<td><h4><?php echo esc_html__('Blog Gird Style', 'bptbusinessline'); ?></h4></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
                     <tr>
